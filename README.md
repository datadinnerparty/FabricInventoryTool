...
* the security group that contains the service principal must be enabled ot use the fabric apis, and the fabric admin apis.
...
* FabricInventoryTool_Setup - a notebook that you need to run only once to setup the lakehouse and tables needed.  Once this notebook completes successfully, it can be removed.
...
# What does the Fabric Inventory Tool Do?
...
# Metadata Included in the Fabric Inventory Tool
