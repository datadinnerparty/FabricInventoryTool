...
The Fabric Inventory Tool collects metadata about all items in all workspaces in a client fabric environmnet, and shows reports of that inventory, including counts over time.
